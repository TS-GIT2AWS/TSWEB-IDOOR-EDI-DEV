...
<head>
    ...
    <!-- The CSS file for upload form -->
	<link rel="stylesheet" href="{{asset('assets/mini-upload-form/assets/css/style.css')}}">
...
<body>
    ...
    <script src="{{asset('assets/js/prettify.js')}}"></script>
        ...
        ================================================== -->
        <script src="{{ asset('assets/mini-upload-form/assets/js/jquery.knob.js') }}"></script>
        
        <!-- jQuery File Upload Dependencies -->
        <script src="{{ asset('assets/mini-upload-form/assets/js/jquery.ui.widget.js') }}"></script>
        <script src="{{ asset('assets/mini-upload-form/assets/js/jquery.iframe-transport.js') }}"></script>
        <script src="{{ asset('assets/mini-upload-form/assets/js/jquery.fileupload.js') }}"></script>
